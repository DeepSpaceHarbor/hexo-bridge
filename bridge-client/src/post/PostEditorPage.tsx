...
export default function PostEditorPage() {
    ...
    const {loading: isLoading, error, data: postData} = useAPI({
        ...getSinglePostAPI,
        data: {
            id: id
        }
    ...
    function getState() {
        ...
        return <>
            <ControlGroup className="margin">
                ...
                <Divider/>
                <ButtonGroup minimal>
                    <Button icon="property" onClick={() => {
                        setShowFrontMatterEditor(true)
                    }}>Categories ({metadata.categories.length})</Button>
                    <Button icon="tag" onClick={() => {
                        setShowFrontMatterEditor(true)
                    }}>Tags ({metadata.tags.length})</Button>
                    <Popover autoFocus={false}>
                        ...
                        <DatePicker value={new Date(metadata.date)}
                    ...
                    <Divider/>
                    <Button icon="annotation" text={"Front matter"} minimal
                            onClick={() => {
                                setShowFrontMatterEditor(true);
                            }}/>
