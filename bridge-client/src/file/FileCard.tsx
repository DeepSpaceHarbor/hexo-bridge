...
export default function FileCard({file}: { file: IFileInfo }) {
    ...
    >
        ...
        <span className="file-info-container">
            <Icon icon={<img width={24} height={24} className="center-horizontal" src={getIconForFile(file)}
                             alt="File icon"/>}/>
        ...
        >
            <p>Are you sure that you want to permanently delete <b>{file.name}</b>?</p>
        </Alert>
    </>
}