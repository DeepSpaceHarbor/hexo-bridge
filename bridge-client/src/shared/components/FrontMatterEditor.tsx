...
export default function FrontMatterEditor({value, onClose, isOpen}: FrontMatterEditorProps) {
    ...
    return <>
        <Dialog icon="annotation" title="Front matter editor" isOpen={isOpen}
            ...
            />
            <Alert isOpen={!canBeClosed} intent={Intent.PRIMARY} icon="error"
                   confirmButtonText="Go back" cancelButtonText="Discard changes"
                   onCancel={() => {
                       setMetadata(value);
                       setCanBeClosed(true)
                       onClose(value);
            ...
            >
                <p><b>Front matter contains errors.</b></p>
